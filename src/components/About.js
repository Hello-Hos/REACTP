    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-blue-500 to-green-400 flex flex-col items-center justify-center py-8 px-4 mt-16">
            <div className="max-w-3xl text-center bg-white p-8 rounded-lg shadow-xl mt-8">
                <h1 className="text-5xl font-extrabold mb-6 text-[#FF6600]">BigBite: Your Food, Your Way</h1>
                ...
                <div className="bg-[#FBCEB1] shadow-lg p-6 rounded-lg mt-6">
                    <h2 className="text-2xl font-semibold text-grey mb-4">Why Choose BigBite?</h2>
